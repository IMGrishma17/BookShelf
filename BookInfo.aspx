<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="BookInfo.aspx.cs" Inherits="BookShelf.BookInfo" %>
                                                    ...
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="row">
                                                            <div class="col" align="right"">
                                                                ...
                                                                <asp:Button class="btn btn-lg btn-info" ID="LinkButton2" runat="server" CommandArgument='<%#Eval("C_Id")%>' Text="Delete" OnClick="btnDelete_Click" />
                                                                <%--<asp:Button ID="Button1" cssClass="btn btn-info" runat="server" Text="Delete" OnClick="btnDelete_Click" />--%>
